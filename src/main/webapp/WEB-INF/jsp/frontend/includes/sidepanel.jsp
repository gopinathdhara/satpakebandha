...
<div id="side-panel" class="bg-black-111">
  <div class="side-panel-wrap">
    ...
    <a class="menuzord-brand pull-left flip font-great-vibes text-white font-24 pt-30 pb-30" href="javascript:void(0)">7pake &nbsp;<i class="fa fa-heart font-25"></i> bandha</a>
