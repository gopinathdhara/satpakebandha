  ...
  <div class="main-content">
    ...
    <section style="margin-top:40px">
      ...
      <div class="col-md-7" style="border: 1px solid #d1d1d1;padding: 20px; margin:10px">
            ...
            <form action="savedsearchupdate" name="reg-form" class="register-form" method="post" >
		              ...
		              <div class="icon-box mb-0 p-0">
		               <a href="javascript:void(0)" class="icon icon-bordered icon-rounded icon-sm pull-left mb-0 mr-10">
		                ...
		                <h4 class="text-gray pt-10 mt-0 mb-30 mytxtdesgn">Update  Saved Search</h4>
              ...
              <div id="step1">
	                <div class="row">
	              		<div class="form-group col-md-12">
		              			...
		              			<p class="text-gray">You can edit your saved search here.</p>
		             			...
		             			%>
		             			<input type="hidden" name="savedsearchid" value="<%= rsobj.getId() %>"/>
		             			<input type="hidden" name="search_name" value="<%= rsobj.getSearch_name() %>"/>
	             		</div>
              ...
              <div id="step2" >
			              		...
			              		<div class="row">
				             		...
				             		<div class="form-group col-md-12"  style="border-bottom: 1px dotted green;">
						             	<p style="color: green;font-weight: bold;">** Profile Details</p>
			            ...
			            <div class="row">
				             		...
				             		<div class="form-group col-md-12"  style="border-bottom: 1px dotted green;">
						             	<p style="color: red;font-weight: bold;"> ** Location Preferences</p> 
		   		...
		   		<div id="step3" >  
					           		...
					           		<div class="form-group col-md-12"  style="border-bottom: 1px dotted green;">
						             	<p style="color: #1601CF;font-weight: bold;">  ** Career Details</p>
			   			...
			   			<div class="row">
			             	 ...
			             	 <div class="form-group  col-md-6">
			                	...
			                	<button class="btn btn-dark btn-lg btn-block mt-15" type="submit" style="background: rgb(245, 131, 32) !important; width:40%;">Update</button>
			             	 </div>
		             	 </div>
